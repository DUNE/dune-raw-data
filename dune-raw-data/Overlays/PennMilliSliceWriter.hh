...
#include "dune-raw-data/Overlays/PennMicroSliceWriter.hh"

namespace dune {
  class PennMilliSliceWriter;
}

class dune::PennMilliSliceWriter : public dune::PennMilliSlice {
...
#endif /* dune_artdaq_Overlays_PennMilliSliceWriter_hh */
