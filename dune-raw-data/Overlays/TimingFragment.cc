...
void dune::TimingFragment::checkADCData(int daq_adc_bits) const {
  dune::TimingFragment::adc_t const * adcPtr(findBadADC(daq_adc_bits));
  if (adcPtr != dataEnd()) {
