...
//std::shared_ptr<dune::MicroSliceWriter> TODO
//dune::TpcMilliSliceWriter::reserveMicroSlice(uint32_t ms_max_bytes)
//{
...
int32_t dune::TpcMilliSliceWriter::finalize(uint32_t data_size_bytes, uint32_t microslice_count)
{
...
//void dune::TpcMilliSliceWriter::finalizeLatestMicroSlice_()
//{
...
dune::TpcMilliSliceWriter::Header* dune::TpcMilliSliceWriter::header_()
{
  return reinterpret_cast<Header *>(buffer_);
}

//uint8_t* dune::TpcMilliSliceWriter::data_(int index) TODO
//{
