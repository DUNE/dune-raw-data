#ifndef dune_artdaq_Overlays_TpcMillisliceWriter_hh
#define dune_artdaq_Overlays_TpcMilliSliceWriter_hh

#include "dune-raw-data/Overlays/TpcMilliSlice.hh"
//#include "dune-raw-data/Overlays/TpcMicroSliceWriter.hh" TODO

namespace dune {
  class TpcMilliSliceWriter;
}

class dune::TpcMilliSliceWriter : public dune::TpcMilliSlice {
...
#endif /* dune_artdaq_Overlays_TpcMilliSliceWriter_hh */
