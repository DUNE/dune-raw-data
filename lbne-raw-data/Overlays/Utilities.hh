#ifndef lbne_artdaq_Overlays_Utilities_hh
#define lbne_artdaq_Overlays_Utilities_hh
...
void display_bits(void* memstart, size_t nbytes, std::string sourcename = "lbne_display_bits");
